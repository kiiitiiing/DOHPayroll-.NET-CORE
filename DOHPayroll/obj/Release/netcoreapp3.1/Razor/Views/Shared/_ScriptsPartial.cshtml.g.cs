#pragma checksum "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "a7b61e16ddabe416abbb0c43949bfcf8086ea1aa"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"a7b61e16ddabe416abbb0c43949bfcf8086ea1aa", @"/Views/Shared/_ScriptsPartial.cshtml")]
...
#nullable disable
    ...
    //UPDATE REGULAR PAYROLL
    function UpdateRegularPayroll(button) {
        var payrollId = $(button).val();
        var userid = $(button).data('params').split('-')[0];
        var fname = $(button).data('params').split('-')[1];
        var mname = $(button).data('params').split('-')[2];
        var lname = $(button).data('para");
            WriteLiteral("ms\').split(\'-\')[3];\r\n        var salary = $(button).data(\'params\').split(\'-\')[4];\r\n        var url = \'");
#nullable restore
#line 994 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
...
#nullable disable
        ...
        $.when($.ajax({
            ...
            async: true,
            beforeSend: function () {
                if ($('#' + rePayrollContainer).children().length > 0) {
                    $(window).scrollTop($('#' + rePayrollContainer).offset().top);
                    $('#' + rePayrollContainer).find('.card').append(loadingSnippet);
                }
                else {
                    $(window).scrollTop($('#' + rePayrollContainer).offset().top);
                    $('#' + rePayrollContainer).append(loadingSnippetDiv);
                }
            },
            success: function (output) {
                if ($('#' + rePayrollContainer).children().length > 0) {
            ...
            WriteLiteral(@"();
                ...
                $('#' + rePayrollContainer).html(output);
                $(window).scrollTop($('#' + rePayrollContainer).offset().top);
            },
            error: function (xhr, ajaxOptions, thrownError) {
                if (xhr.status === 401) {
    ...
    function LoadJoPayrollandList(row) {
        ...
        var fname = row.find('td:eq(5)').text().trim();
        var mname = row.find('td:eq(6)').text().trim();
        var lname = row.find('td:eq(7)').text().trim();
        var salary = row");
            WriteLiteral(".find(\'td:eq(4)\').text().trim();\r\n        var url = \'");
#nullable restore
#line 1048 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
              Write(Url.Action("EditJoPayroll","PartialView"));
...
#nullable disable
    ...
    function LoadHazardAndList(row) {
        ...
        var url = ");
            WriteLiteral("\'");
#nullable restore
#line 1101 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
...
#nullable disable
    ...
    function LoadHazard(userid) {
        var listUrl = '");
#nullable restore
#line 1148 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
...
#nullable restore
#line 1183 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
...
#nullable disable
    ...
    function LoadCellphoneList(userid) {
        var listUrl = '");
#nullable restore
#line 1230 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
...
#nullable restore
#line 1265 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
...
#nullable disable
    ...
    function LoadLongevityList(userid) {
        var listUrl = '");
#nullable restore
#line 1312 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
...
#nullable disable
    ...
    function LoadSubsistenceAndList(row) {
        ...
        var userid = row.find('td:eq(0)'");
            WriteLiteral(").text().trim();\r\n        var fname = row.find(\'td:eq(5)\').text().trim();\r\n        var mname = row.find(\'td:eq(6)\').text().trim();\r\n        var lname = row.find(\'td:eq(7)\').text().trim();\r\n        var url = \'");
#nullable restore
#line 1348 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
...
#nullable disable
    ...
    function LoadSubsistenceList(userid) {
        var listUrl = '");
#nullable restore
#line 1395 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
...
#nullable disable
    ...
    function LoadRataAndList(row) {
        ...
        var url = '");
#nullable restore
#line 1438 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
...
#nullable disable
    ...
    function LoadRataList(userid) {
        var listUrl = '");
#nullable restore
#line 1485 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
...
#nullable disable
    ...
    function LoadRegularPayrollandList(row) {
        ...
        var mname = row.find('td:eq(6)').text().trim();
        var lname = row.find('td:eq(7)').text().trim();
        var salary = row.find('td:eq(4)').text().trim();
        var url = '");
#nullable restore
#line 1521 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
              Write(Url.Action("EditRegularPayroll","PartialView"));
...
#nullable disable
    ...
    function LoadRegularPayrollList(userid) {
        var listUrl = '");
#nullable restore
#line 1569 "C:\Users\Keith\source\repos\DOHPayroll\DOHPayroll\Views\Shared\_ScriptsPartial.cshtml"
